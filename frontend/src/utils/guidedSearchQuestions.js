const questions = {
  ...
  steps: {
    ...
    "2": {
      ...
      "text": "무엇을 하시나요?",
      "options": [
        { "value": "food", "text": "음식", "icon": "🍔", "nextStep": 3, "path": "food" },
        { "value": "event", "text": "행사", "icon": "🎉", "nextStep": 100, "path": "event" },
        { "value": "tourist_spot", "text": "관광지", "icon": "🏞️", "nextStep": 200, "path": "tourist" }
      ]
    },
    "3": {
